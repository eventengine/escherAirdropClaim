...
.directive('blockieAddress', blockiesDirective);
...
function blockiesDirective() {
  ...
  function link(scope, element, attrs){
    ...
    scope.$watch(watchVar, function() {
      ...
      console.log(':' + attrs.blockieAddress);
      var content = globalFuncs.getBlockie(attrs.blockieAddress);
